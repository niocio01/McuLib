 ...
 * \return Error code, ERR_OK if no failure.
 */
uint8_t McuPCF85263A_ReadAlarmSecond(uint8_t *second, bool *enabled);
 ...
 * \return Error code, ERR_OK if no failure.
 */
uint8_t McuPCF85263A_WriteAlarmSecond(uint8_t second, bool enable);
 ...
 * \return Error code, ERR_OK if no failure.
 */
uint8_t McuPCF85263A_ReadAlarmMinute(uint8_t *minute, bool *enabled);
 ...
 * \return Error code, ERR_OK if no failure.
 */
uint8_t McuPCF85263A_WriteAlarmMinute(uint8_t minute, bool enable);
 ...
 * \return Error code, ERR_OK if no failure.
 */
uint8_t McuPCF85263A_ReadAlarmHour(uint8_t *hour, bool *enabled, bool *is24h, bool *isAM);
 ...
 * \return Error code, ERR_OK if no failure.
 */
uint8_t McuPCF85263A_WriteAlarmHour(uint8_t hour, bool enable, bool is24h, bool isAM);
 ...
 * \return Error code, ERR_OK if no failure.
 */
uint8_t McuPCF85263A_ReadAlarmDay(uint8_t *day, bool *enabled);
 ...
 * \return Error code, ERR_OK if no failure.
 */
uint8_t McuPCF85263A_WriteAlarmDay(uint8_t day, bool enable);
 ...
 * \return Error code, ERR_OK if no failure.
 */
uint8_t McuPCF85263A_ReadAlarmWeekDay(uint8_t *weekDay, bool *enabled);
 ...
 * \return Error code, ERR_OK if no failure.
 */
uint8_t McuPCF85263A_WriteAlarmWeekDay(uint8_t weekDay, bool enable);
 ...
 * \return Error code, ERR_OK if no failure.
 */
uint8_t McuPCF85263A_WriteAlarmInterrupt(bool enable);

/*!
 * \brief Reset the alarm interrupt flag
 * \return Error code, ERR_OK if no failure.
 */
uint8_t McuPCF85263A_WriteResetAlarmInterrupt(void);
